<?php
    ...
    $filiere = "ING IV QHSE : Qualité Hygiène et Sécurité en Entreprise";
 ...
 if(!empty($_POST))
 {
    ...
    if($isSuccess && $isUploadSuccess)
    {
        $nbre_filleul = 0;
        $db = Database::connect();
        $statement = $db->prepare("INSERT INTO parrain_qhse (matricule,nom,prenom,nbre_filleul,image,Email,numero) VALUES (? , ?, ?, ?, ?, ?, ?)");
...
<body>
    <section id="formdesti">
        ...
        <p style="font-size: 20px;"><span style="color: green;">Filière</span> <?php echo $filiere; ?></p>
            <div class="row">
                  <form class="form" action="<?php echo 'parrain_qhse.php'; ?>" role="form" id="monform" method="post" enctype="multipart/form-data">
                    <div class="col-sm-6">
