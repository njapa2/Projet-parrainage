<?php
    ...
    $filiere = "ING IV : Génie Mécanique";
 ...
 if(!empty($_POST))
 {
    ...
    if($isSuccess && $isUploadSuccess)
    {
        $nbre_filleul = 0;
        $db = Database::connect();
        $statement = $db->prepare("INSERT INTO parrain_mecanique (matricule,nom,prenom,nbre_filleul,image,Email,numero) VALUES (? , ?, ?, ?, ?, ?, ?)");
...
<body>
    <section id="formdesti">
        ...
        <p style="font-size: 20px;"><span style="color: green;">Filière</span> <?php echo $filiere; ?></p>
            <div class="row">
                  <form class="form" action="<?php echo 'parrain_mecanique.php'; ?>" role="form" id="monform" method="post" enctype="multipart/form-data">
                    <div class="col-sm-6">
