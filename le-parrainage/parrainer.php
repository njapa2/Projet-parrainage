        ...
        <?php
            for($i = 1; $i <= $max ; $i++)
            {
                ...
                echo '          <div class="slides">';
                                ...
                                echo '<div class="slide special specials">
                                        ...
                                        for($j = 1; $j <= 30; $j++)
                                        {
                                            ...
                                            {
                                                $db = Database::connect();
                                                $statement = $db->query("SELECT nom,prenom,image FROM parrain WHERE id = ROUND(RAND()*((SELECT COUNT(*) FROM parrain)-1))+1");
                                            ...
                                            $image = $parrain["image"];
                                            Database::disconnect();
                                            echo '<div class="slide specials">
                                                <center><img src="../images/images-parrains/'.$image.'" alt="..."></center> 
                                            </div>';
                                        }
                                        echo '<div class="slide special specials">
                                                <img src="../images/images-parrains/'.$imageParrain.'" alt="...">
                                    ...
                                    //     echo '<div class="info info-special">
